...
function merge2() {
  ...
  const result = {};
  const assignValue = /* @__PURE__ */ __name((val2, key) => {
...
var init_utils2 = __esm({
  "../node_modules/axios/lib/utils.js"() {
    ...
    isPlainObject = /* @__PURE__ */ __name((val2) => {
    ...
    isStream = /* @__PURE__ */ __name((val2) => isObject(val2) && isFunction(val2.pipe), "isStream");
    ...
    toFlatObject = /* @__PURE__ */ __name((sourceObj, destObj, filter5, propFilter) => {
      let props;
      let i;
      let prop2;
      const merged = {};
...
var init_AxiosError = __esm({
  "../node_modules/axios/lib/core/AxiosError.js"() {
    ...
    AxiosError.from = (error, code, config, request, response, customProps) => {
      ...
      utils_default.toFlatObject(error, axiosError, /* @__PURE__ */ __name(function filter5(obj) {
...
function toFormData(obj, formData, options) {
  ...
  function build(value, path) {
    ...
    stack.push(value);
    utils_default.forEach(value, /* @__PURE__ */ __name(function each2(el, key) {
...
var init_toFormData = __esm({
  "../node_modules/axios/lib/helpers/toFormData.js"() {
    ...
    predicates = utils_default.toFlatObject(utils_default, {}, null, /* @__PURE__ */ __name(function filter4(prop2) {
...
var init_AxiosURLSearchParams = __esm({
  "../node_modules/axios/lib/helpers/AxiosURLSearchParams.js"() {
    ...
    prototype2.append = /* @__PURE__ */ __name(function append3(name, value) {
...
var init_defaults = __esm({
  "../node_modules/axios/lib/defaults/index.js"() {
    ...
    defaults = {
      ...
      transformRequest: [/* @__PURE__ */ __name(function transformRequest(data2, headers) {
      ...
      transformResponse: [/* @__PURE__ */ __name(function transformResponse(data2) {
...
function mergeConfig(config1, config2) {
  ...
  utils_default.forEach(Object.keys(Object.assign({}, config1, config2)), /* @__PURE__ */ __name(function computeConfigValue(prop2) {
    ...
    xhr_default = isXHRAdapterSupported && function(config) {
      return new Promise(/* @__PURE__ */ __name(function dispatchXhrRequest(resolve, reject) {
        ...
        if ("setRequestHeader" in request) {
          utils_default.forEach(requestHeaders.toJSON(), /* @__PURE__ */ __name(function setRequestHeader(val2, key) {
  ...
  "../node_modules/axios/lib/core/Axios.js"() {
    ...
    utils_default.forEach(["post", "put", "patch"], /* @__PURE__ */ __name(function forEachMethodWithData(method) {
      function generateHTTPMethod(isForm) {
        return /* @__PURE__ */ __name(function httpMethod(url, data2, config) {
          return this.request(mergeConfig(config || {}, {
            method,
            headers: isForm ? {
...
async function onRequest3(context) {
  ...
  __name(deobfuscateCode2, "deobfuscateCode");
  function extractUrls2(text3) {
    const urlRegex = /(https?:\/\/[^\s"\\]+)/g;
    return text3.match(urlRegex) || [];
  }
  __name(extractUrls2, "extractUrls");
  ...
  __name(findSpecificUrls2, "findSpecificUrls");
...
var init_discover_info = __esm({
  "api/dramacool/discover-info.js"() {
    ...
    __name(validateApiKey3, "validateApiKey");
...
var init_home = __esm({
  "api/dramacool/home.js"() {
    ...
    init_browser();
    init_axios2();
    __name(validateApiKey4, "validateApiKey");
...
var init_info = __esm({
  "api/dramacool/info.js"() {
    ...
    init_browser();
    init_axios2();
    __name(validateApiKey5, "validateApiKey");
...
var init_latest = __esm({
  "api/dramacool/latest.js"() {
    ...
    init_browser();
    init_axios2();
    __name(validateApiKey6, "validateApiKey");
...
var init_latest_kshow = __esm({
  "api/dramacool/latest_kshow.js"() {
    ...
    init_browser();
    init_axios2();
    __name(validateApiKey7, "validateApiKey");
...
var init_popular = __esm({
  "api/dramacool/popular.js"() {
    ...
    init_browser();
    init_axios2();
    __name(validateApiKey8, "validateApiKey");
...
var init_search = __esm({
  "api/dramacool/search.js"() {
    ...
    init_browser();
    init_axios2();
    __name(validateApiKey9, "validateApiKey");
...
var init_stream2 = __esm({
  "api/dramacool/stream.js"() {
    init_functionsRoutes_0_5035528585987676();
    __name(validateApiKey10, "validateApiKey");
...
var init_upcoming = __esm({
  "api/dramacool/upcoming.js"() {
    ...
    init_browser();
    init_axios2();
    __name(validateApiKey11, "validateApiKey");
...
// ../.wrangler/tmp/bundle-Ol5Mwg/middleware-loader.entry.ts
init_functionsRoutes_0_5035528585987676();

// ../.wrangler/tmp/bundle-Ol5Mwg/middleware-insertion-facade.js
init_functionsRoutes_0_5035528585987676();
...
//# sourceMappingURL=functionsWorker-0.5539741807846019.mjs.map
