...
// .wrangler/tmp/bundle-RfJCdY/checked-fetch.js
...
// .wrangler/tmp/pages-5bJw9u/functionsWorker-0.6115297774179753.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-w0ehzi/checked-fetch.js"() {
...
var init_esm = __esm({
  "../node_modules/domelementtype/lib/esm/index.js"() {
    init_functionsRoutes_0_4848703369901559();
    init_checked_fetch();
...
function extractVideoData(html3) {
  ...
  const videoSource = $2("video.v-player source").attr("src");
  if (videoSource) {
    return { preview: videoSource };
  } else {
    return { error: "Video source not found" };
  }
}
__name(extractVideoData, "extractVideoData");
var init_get_video = __esm({
  "api/get_video.js"() {
    init_functionsRoutes_0_4848703369901559();
    init_checked_fetch();
    init_browser();
...
async function onRequestGet2({ request }) {
  ...
  if (!imageUrl) {
    return new Response(
      JSON.stringify({ error: "Missing image URL in query parameters" }),
      {
        status: 400,
        headers: {
          "Content-Type": "application/json",
  ...
  try {
    const fetchRequest = new Request(imageUrl, {
      headers: {
        Accept: "image/avif,image/webp,image/apng,image/svg+xml,image/*,*/*;q=0.8",
        "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.6 Mobile/15E148 Safari/604.1",
        Referer: "https://masahub2.com/"
        // Required to bypass hotlinking
      }
    });
    ...
    return new Response(imageBuffer, {
      ...
      headers: {
        ...
        Expires: "0",
        ETag: "",
        // Remove ETag to prevent future conditional requests
        "Last-Modified": ""
        // Remove Last-Modified for the same reason
      }
    });
  } catch (error) {
    return new Response(JSON.stringify({ error: error.message }), {
...
async function onRequestGet3({ request }) {
  ...
  const targetURL = `https://masahub2.com/page/${page}/`;
  try {
    const headers = {
      Accept: "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7",
      "Accept-Language": "en-US,en;q=0.9",
...
function extractVideoData2(html3) {
  ...
  return videoElements.map((_, video) => {
    ...
    const time = element.find(".thumb__wrap .duration").text().trim();
    const preview = element.find(".thumb__wrap img").attr("src");
    const href = element.find(".title a").attr("href");
    return { title, time, preview, href };
  }).get();
}
...
var routes;
var init_functionsRoutes_0_4848703369901559 = __esm({
  "../.wrangler/tmp/pages-5bJw9u/functionsRoutes-0.4848703369901559.mjs"() {
    init_get_video();
    init_image_proxy();
    init_scrape();
    routes = [
...
// .wrangler/tmp/bundle-RfJCdY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RfJCdY/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.6115297774179753.js.map
