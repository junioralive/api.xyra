...
// .wrangler/tmp/pages-mdoskE/functionsWorker-0.5539741807846019.mjs
...
var init_esm = __esm({
  "../node_modules/domelementtype/lib/esm/index.js"() {
    init_functionsRoutes_0_5035528585987676();
...
var init_node = __esm({
  "../node_modules/domhandler/lib/esm/node.js"() {
    ...
    __name2(Node, "Node");
    DataNode = /* @__PURE__ */ __name(class extends Node {
      /**
    ...
    __name2(DataNode, "DataNode");
    Text2 = /* @__PURE__ */ __name(class extends DataNode {
      constructor() {
        super(...arguments);
    ...
    __name2(Text2, "Text");
    Comment2 = /* @__PURE__ */ __name(class extends DataNode {
      constructor() {
        super(...arguments);
    ...
    ProcessingInstruction = /* @__PURE__ */ __name(class extends DataNode {
    ...
    __name2(ProcessingInstruction, "ProcessingInstruction");
    NodeWithChildren = /* @__PURE__ */ __name(class extends Node {
      /**
    ...
    __name2(NodeWithChildren, "NodeWithChildren");
    CDATA2 = /* @__PURE__ */ __name(class extends NodeWithChildren {
      constructor() {
        super(...arguments);
    ...
    Document = /* @__PURE__ */ __name(class extends NodeWithChildren {
      constructor() {
        super(...arguments);
    ...
    Element = /* @__PURE__ */ __name(class extends NodeWithChildren {
      /**
...
var init_esm2 = __esm({
  "../node_modules/domhandler/lib/esm/index.js"() {
    ...
    DomHandler = /* @__PURE__ */ __name(class {
      /**
...
var init_decode = __esm({
  "../node_modules/entities/lib/esm/decode.js"() {
    ...
    EntityDecoder = /* @__PURE__ */ __name(class {
    ...
    __name2(EntityDecoder, "EntityDecoder");
...
function getLoad(parse7, render3) {
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function load2(content, options, isDocument2 = true) {
    ...
    __name2(LoadedCheerio, "LoadedCheerio");
...
var init_preprocessor = __esm({
  "../node_modules/parse5/dist/tokenizer/preprocessor.js"() {
    ...
    Preprocessor = /* @__PURE__ */ __name(class {
      constructor(handler) {
...
var init_tokenizer = __esm({
  "../node_modules/parse5/dist/tokenizer/index.js"() {
    ...
    Tokenizer = /* @__PURE__ */ __name(class {
...
var init_open_element_stack = __esm({
  "../node_modules/parse5/dist/parser/open-element-stack.js"() {
    ...
    OpenElementStack = /* @__PURE__ */ __name(class {
    ...
    __name2(OpenElementStack, "OpenElementStack");
  }
});
...
var init_formatting_element_list = __esm({
  "../node_modules/parse5/dist/parser/formatting-element-list.js"() {
    ...
    FormattingElementList = /* @__PURE__ */ __name(class {
    ...
    __name2(FormattingElementList, "FormattingElementList");
  }
});
...
var init_Tokenizer = __esm({
  "../node_modules/htmlparser2/lib/esm/Tokenizer.js"() {
    ...
    Tokenizer2 = /* @__PURE__ */ __name(class {
...
async function onRequestGet({ request }) {
  ...
  try {
    ...
    let html3 = await fetchAndFollowRedirects(videoUrl, headers);
    if (!html3) {
      return new Response(
    ...
    const downloadLinks = extractDownloadLinks(html3);
...
async function fetchAndFollowRedirects(url, headers) {
  try {
    ...
    let $2 = load(html3);
    const metaRedirect = $2('meta[http-equiv="refresh"]').attr("content");
    if (metaRedirect) {
    ...
    const jsRedirect = $2("body").attr("onload");
    ...
    const targetHref = $2(".vd a.btn").attr("href");
    if (targetHref) {
...
__name(fetchAndFollowRedirects, "fetchAndFollowRedirects");
function extractDownloadLinks(html3) {
  const $2 = load(html3);
  const links = {};
  const greenButton = $2("a.btn-success.btn-lg.h6").first();
  if (greenButton.length) {
    links.greenDownloadButton = greenButton.attr("href") || null;
  }
  const redButton = $2("a.btn-danger.btn-lg.h6").first();
  if (redButton.length) {
...
var init_getStream = __esm({
  "api/moviesdrive/getStream.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    __name2(onRequestGet, "onRequestGet");
    __name2(fetchAndFollowRedirects, "fetchAndFollowRedirects");
    __name2(extractDownloadLinks, "extractDownloadLinks");
  }
});
...
<body>
  <main class="main">
    ...
    <div class="muted">\u{1F512} Every request requires an API key. No exceptions!</div>
...
.catch(error => console.error(error));
    ...
    <p class="small-text">
      PS: Always keep your API key secure. Sharing it with others may result in unexpected drama. \u{1F31F}
    </p>
  </main>
  <footer class="footer">
    \xA9 2025 Xyra API - Brought to you by drama-loving coder JuniorAlive. \u{1F3AD}
  </footer>
</body>
</html>
        `,
...
var init_doc = __esm({
  "api/dramacool_beta/doc.js"() {
    init_functionsRoutes_0_5035528585987676();
    __name2(onRequest, "onRequest");
  }
});
function bind(fn, thisArg) {
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function wrap2() {
...
function merge2() {
  ...
  const result = {};
  const assignValue = /* @__PURE__ */ __name2((val2, key) => {
...
var init_utils2 = __esm({
  "../node_modules/axios/lib/utils.js"() {
    ...
    isPlainObject = /* @__PURE__ */ __name2((val2) => {
    ...
    isStream = /* @__PURE__ */ __name2((val2) => isObject(val2) && isFunction(val2.pipe), "isStream");
    ...
    toFlatObject = /* @__PURE__ */ __name2((sourceObj, destObj, filter5, propFilter) => {
      let props;
      let i;
      let prop2;
      const merged = {};
    ...
    toArray2 = /* @__PURE__ */ __name2((thing) => {
      if (!thing)
        return null;
      if (isArray(thing))
        return thing;
    ...
    generateString = /* @__PURE__ */ __name2((size = 16, alphabet = ALPHABET.ALPHA_DIGIT) => {
      let str = "";
...
var init_AxiosError = __esm({
  "../node_modules/axios/lib/core/AxiosError.js"() {
    ...
    AxiosError.from = (error, code, config, request, response, customProps) => {
      ...
      utils_default.toFlatObject(error, axiosError, /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function filter5(obj) {
        return obj !== Error.prototype;
      }, "filter5"), "filter"), (prop2) => {
...
function renderKey(path, key, dots) {
  if (!path)
    return key;
  return path.concat(key).map(/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function each2(token, i) {
    token = removeBrackets(token);
    return !dots && i ? "[" + token + "]" : token;
  }, "each2"), "each")).join(dots ? "." : "");
}
...
function toFormData(obj, formData, options) {
  ...
  function defaultVisitor(value, key, path) {
    ...
    if (value && !path && typeof value === "object") {
      if (utils_default.endsWith(key, "{}")) {
        ...
        arr.forEach(/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function each2(el, index2) {
  ...
  function build(value, path) {
    ...
    stack.push(value);
    utils_default.forEach(value, /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function each2(el, key) {
...
var init_toFormData = __esm({
  "../node_modules/axios/lib/helpers/toFormData.js"() {
    ...
    predicates = utils_default.toFlatObject(utils_default, {}, null, /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function filter4(prop2) {
...
var init_AxiosURLSearchParams = __esm({
  "../node_modules/axios/lib/helpers/AxiosURLSearchParams.js"() {
    ...
    prototype2.append = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function append3(name, value) {
      this._pairs.push([name, value]);
    }, "append3"), "append");
    prototype2.toString = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function toString3(encoder) {
      const _encode = encoder ? function(value) {
        return encoder.call(this, value, encode);
      } : encode;
      return this._pairs.map(/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function each2(pair) {
...
var init_InterceptorManager = __esm({
  "../node_modules/axios/lib/core/InterceptorManager.js"() {
    ...
    init_functionsRoutes_0_5035528585987676();
    init_utils2();
    InterceptorManager = /* @__PURE__ */ __name(class {
      constructor() {
        this.handlers = [];
      }
      /**
    ...
    __name2(InterceptorManager, "InterceptorManager");
...
var init_defaults = __esm({
  "../node_modules/axios/lib/defaults/index.js"() {
    ...
    defaults = {
      ...
      transformRequest: [/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function transformRequest(data2, headers) {
      ...
      transformResponse: [/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function transformResponse(data2) {
...
var init_AxiosHeaders = __esm({
  "../node_modules/axios/lib/core/AxiosHeaders.js"() {
    ...
    AxiosHeaders = /* @__PURE__ */ __name(class {
      constructor(headers) {
    ...
    __name2(AxiosHeaders, "AxiosHeaders");
...
function mergeConfig(config1, config2) {
  ...
  utils_default.forEach(Object.keys(Object.assign({}, config1, config2)), /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function computeConfigValue(prop2) {
    ...
    xhr_default = isXHRAdapterSupported && function(config) {
      return new Promise(/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function dispatchXhrRequest(resolve, reject) {
        ...
        if ("setRequestHeader" in request) {
          utils_default.forEach(requestHeaders.toJSON(), /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function setRequestHeader(val2, key) {
...
var init_adapters = __esm({
  "../node_modules/axios/lib/adapters/adapters.js"() {
    ...
    isResolvedHandle = /* @__PURE__ */ __name2((adapter2) => utils_default.isFunction(adapter2) || adapter2 === null || adapter2 === false, "isResolvedHandle");
    adapters_default = {
      getAdapter: (adapters) => {
...
function dispatchRequest(config) {
  ...
  return adapter2(config).then(/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function onAdapterResolution(response) {
    throwIfCancellationRequested(config);
  ...
  "../node_modules/axios/lib/core/Axios.js"() {
    ...
    utils_default.forEach(["post", "put", "patch"], /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function forEachMethodWithData(method) {
      function generateHTTPMethod(isForm) {
        return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function httpMethod(url, data2, config) {
          return this.request(mergeConfig(config || {}, {
            method,
            headers: isForm ? {
...
var init_CancelToken = __esm({
  "../node_modules/axios/lib/cancel/CancelToken.js"() {
    ...
    init_functionsRoutes_0_5035528585987676();
    init_CanceledError();
    CancelToken = /* @__PURE__ */ __name(class {
      ...
      static source() {
        let cancel;
        const token = new CancelToken(/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function executor(c) {
          cancel = c;
        }, "executor"), "executor"));
        return {
          token,
    ...
    __name2(CancelToken, "CancelToken");
    CancelToken_default = CancelToken;
  }
});
function spread(callback) {
  return /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function wrap2(arr) {
...
async function onRequest2(context) {
  ...
  try {
    const pageResponse = await axios_default.get(pageUrl);
    const $2 = load(pageResponse.data);
    const iframeSrc = $2('iframe[title*="Episode"]').attr("src");
    if (!iframeSrc) {
      return new Response(
    ...
    const iframeResponse = await axios_default.get(iframeUrl);
    const iframeHtml = load(iframeResponse.data);
...
var init_getm3u8 = __esm({
  "api/dramacool_beta/getm3u8.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_axios2();
    init_browser();
...
async function onRequest3(context) {
  function deobfuscateCode2(p, a, c, k, e, d) {
    while (c--) {
      if (k[c]) {
  ...
  __name(deobfuscateCode2, "deobfuscateCode2");
  __name2(deobfuscateCode2, "deobfuscateCode");
  function extractUrls2(text3) {
    const urlRegex = /(https?:\/\/[^\s"\\]+)/g;
    return text3.match(urlRegex) || [];
  }
  __name(extractUrls2, "extractUrls2");
  __name2(extractUrls2, "extractUrls");
  function findSpecificUrls2(urls) {
  ...
  __name(findSpecificUrls2, "findSpecificUrls2");
  __name2(findSpecificUrls2, "findSpecificUrls");
  ...
  if (request.method === "GET") {
    ...
    const deobfuscatedOutput = deobfuscateCode2(
      obfuscatedCode,
      deobfuscationKey,
      arrayLength,
      deobfuscationArray
    );
    const urls = extractUrls2(deobfuscatedOutput);
    const result = findSpecificUrls2(urls);
...
var init_getVideo = __esm({
  "api/dramacool_beta/getVideo.js"() {
    init_functionsRoutes_0_5035528585987676();
...
async function onRequest4(context) {
  ...
  if (request.method === "GET") {
    ...
    try {
      ...
      let scriptContent;
      let match2;
      while ((match2 = scriptRegex.exec(html3)) !== null) {
        if (match2[1].includes("eval(function(p,a,c,k,e,d)")) {
          scriptContent = match2[1];
          break;
        }
      }
      if (!scriptContent) {
...
var init_getVideoTest = __esm({
  "api/dramacool_beta/getVideoTest.js"() {
    init_functionsRoutes_0_5035528585987676();
    __name2(onRequest4, "onRequest");
  }
});
function validateApiKey(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
...
__name(deobfuscateCode, "deobfuscateCode");
function extractUrls(text3) {
  const urlRegex = /(https?:\/\/[^\s"\\]+)/g;
  return text3.match(urlRegex) || [];
}
...
__name(findSpecificUrls, "findSpecificUrls");
async function onRequest5(context) {
  ...
  if (method === "GET") {
    const { searchParams } = new URL(request.url);
    apiKey2 = searchParams.get("api_key");
    videoURL = searchParams.get("url");
  } else if (method === "POST") {
    const body = await request.json();
    apiKey2 = body.api_key;
    videoURL = body.url;
  }
  if (!apiKey2 || !validateApiKey(apiKey2, env2)) {
    return new Response(
      JSON.stringify({
        success: false,
...
var init_play = __esm({
  "api/dramacool_beta/play.js"() {
    init_functionsRoutes_0_5035528585987676();
    __name2(validateApiKey, "validateApiKey");
    __name2(deobfuscateCode, "deobfuscateCode");
    __name2(extractUrls, "extractUrls");
    __name2(findSpecificUrls, "findSpecificUrls");
  ...
  try {
    ...
    if (url.endsWith(".m3u8")) {
      ...
      const rewrittenPlaylist = playlist.replace(
        /(https?:\/\/[^\s]+)/g,
        (match2) => `/api/dramacool/stream?url=${encodeURIComponent(match2)}`
      );
...
var init_stream = __esm({
  "api/dramacool_beta/stream.js"() {
    init_functionsRoutes_0_5035528585987676();
    __name2(onRequest7, "onRequest");
  }
});
function validateApiKey2(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
__name(validateApiKey2, "validateApiKey2");
async function onRequest8({ request, env: env2 }) {
  try {
    ...
    if (!apiKey2 || !validateApiKey2(apiKey2, env2)) {
      return new Response(
        JSON.stringify({
          success: false,
          message: "Invalid or missing API key. You can\u2019t call this a drama API without the drama of finding your missing key!",
          protip: "Missing API key? Join our Discord and claim yours\u2014it\u2019s free, and way better than staring at this error. \u{1F449} https://discord.gg/cwDTVKyKJz"
        }),
        { status: 401, headers: { "Content-Type": "application/json" } }
      );
    }
    ...
    if (releaseYear)
      queryParams.append("release-year", releaseYear);
    const targetUrl = `${baseUrl}?${queryParams.toString()}&page=${page}`;
    const response = await axios_default.get(targetUrl);
    const html3 = response.data;
    const $2 = load(html3);
    const dramas = [];
    $2("#primary .box li").each((_, element) => {
      const title = $2(element).find("h3").text().trim();
      let link = $2(element).find("a").attr("href");
      const image = $2(element).find("img").attr("data-original") || $2(element).find("img").attr("src");
      const episode = $2(element).find(".ep").text().trim();
      const time = $2(element).find(".time").text().trim();
    ...
    const nextPage = $2(".pagination .next.page-numbers").attr("href") ? true : false;
    const prevPage = $2(".pagination .prev.page-numbers").attr("href") ? true : false;
    const maxPage = $2(".pagination .page-numbers").not(".dots, .prev, .next, .current").last().text();
    return new Response(
      JSON.stringify({
        success: true,
        data: dramas,
...
var init_discover = __esm({
  "api/dramacool/discover.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    init_axios2();
    __name2(validateApiKey2, "validateApiKey");
    __name2(onRequest8, "onRequest");
  }
});
function validateApiKey3(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
__name(validateApiKey3, "validateApiKey3");
async function onRequest9({ request, env: env2 }) {
  try {
    const url = new URL(request.url);
    const apiKey2 = url.searchParams.get("api_key");
    if (!apiKey2 || !validateApiKey3(apiKey2, env2)) {
      return new Response(
        JSON.stringify({
          success: false,
          message: "Invalid or missing API key. You can\u2019t call this a drama API without the drama of finding your missing key!",
    ...
    return new Response(JSON.stringify({
      success: true,
      data: filters2
      // Replace 'filters' with the actual data variable name if different
    }), {
      headers: { "Content-Type": "application/json" }
    });
  } catch (error) {
...
var filters2;
var init_discover_info = __esm({
  "api/dramacool/discover-info.js"() {
    init_functionsRoutes_0_5035528585987676();
    filters2 = {
      country: {
        "Chinese": "chinese",
    ...
    __name2(validateApiKey3, "validateApiKey");
...
<body>
  <main class="main">
    ...
    <div class="muted">\u{1F512} Every request requires an API key. No Drama!</div>

    <div class="card">
      <h2>Code Example for Noobs \u{1F680}</h2>
      <p>
        Welcome to the land of <strong>POST</strong> and <strong>GET</strong>! We support both\u2014because why not? \u{1F60E}<br>
      ...
      <pre>
        ...
        ...and the server\u2019s like, "Got it! Here\u2019s your response." \u{1F4E8}

        <b>GET Example:</b> 
        You\u2019re just browsing\u2014like asking, "Hey server, what\u2019s up?" \u{1F914}
        Server: "Not much, here\u2019s the data you wanted." \u{1F4DC}
      </pre>

      <p>
        Remember: POST is for when you want to <strong>do something</strong> (like sign up for free pizza \u{1F355}). GET is for when you\u2019re just snooping around, politely, of course.
      </p>
...
var init_doc2 = __esm({
  "api/dramacool/doc.js"() {
    init_functionsRoutes_0_5035528585987676();
    __name2(onRequest10, "onRequest");
  }
});
function validateApiKey4(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
__name(validateApiKey4, "validateApiKey4");
async function onRequest11({ request, env: env2 }) {
  try {
    const url = new URL(request.url);
    const apiKey2 = url.searchParams.get("api_key");
    if (!apiKey2 || !validateApiKey4(apiKey2, env2)) {
      return new Response(
        JSON.stringify({
          success: false,
          message: "Invalid or missing API key. You can\u2019t call this a drama API without the drama of finding your missing key!",
    ...
    const response = await axios_default.get("https://dramacool.sh/");
    const html3 = response.data;
    const $2 = load(html3);
    ...
    $2("#drama .box li").each((_, element) => {
      const title = $2(element).find("h3").text().trim();
      const id = $2(element).find("a").attr("href").replace("https://dramacool.sh", "").replace("/", "").replace("/", "");
    ...
    $2("#movie .box li").each((_, element) => {
      const title = $2(element).find("h3").text().trim();
      const id = $2(element).find("a").attr("href").replace("https://dramacool.sh", "").replace("/", "").replace("/", "");
      const image = $2(element).find("img").attr("src");
      const cleanLink = id.replace(/-episode-\d+/i, "");
      recentMovies.push({
        title,
        id: cleanLink,
    ...
    $2(".blog-content .box li").each((_, element) => {
      const title = $2(element).find("h3").text().trim();
      const link = $2(element).find("a").attr("href");
      const image = $2(element).find("img").attr("src");
      const cleanLink = link.replace(/-episode-\d+/i, "");
      blogContent.push({
        title,
    ...
    $2("#popular .short-list li h3 a").each((_, element) => {
      const title = $2(element).text().trim();
      const id = $2(element).attr("href").replace("https://dramacool.sh", "").replace("/", "").replace("/", "");
      const cleanLink = id.replace(/-episode-\d+/i, "");
      ongoingDramas.push({
        title,
        id: cleanLink,
    ...
    $2("#upcoming .short-list li h3 a").each((_, element) => {
      const title = $2(element).text().trim();
      const id = $2(element).attr("href").replace("https://dramacool.sh", "").replace("/", "").replace("/", "");
      const cleanLink = id.replace(/-episode-\d+/i, "");
    ...
    $2(".popular-mob .widget-list li").each((_, element) => {
      const title = $2(element).find("h3 a").text().trim();
      const id = $2(element).find("h3 a").attr("href").replace("https://dramacool.sh", "").replace("/", "").replace("/", "");
      const cleanLink = id.replace(/-episode-\d+/i, "");
...
var init_home = __esm({
  "api/dramacool/home.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    init_axios2();
    __name2(validateApiKey4, "validateApiKey");
    __name2(onRequest11, "onRequest");
  }
});
function validateApiKey5(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
__name(validateApiKey5, "validateApiKey5");
async function onRequest12({ request, env: env2 }) {
  try {
    const url = new URL(request.url);
    const id = url.searchParams.get("id");
    const apiKey2 = url.searchParams.get("api_key");
    if (!apiKey2 || !validateApiKey5(apiKey2, env2)) {
      return new Response(
        JSON.stringify({
          success: false,
          message: "Invalid or missing API key. You can\u2019t call this a drama API without the drama of finding your missing key!",
    ...
    const html3 = response.data;
    const $2 = load(html3);
    const title = $2("#drama-details .entry-header h1").text().trim() || null;
    const thumbnail = $2("#drama-details .drama-thumbnail img").attr("src") || null;
    const synopsis = $2("#drama-details .synopsis p.synopsis").text().trim() || null;
    const other_name = $2("#drama-details .synopsis p.aka").text().replace("Other name: ", "").trim();
    const total_episode = $2("#drama-details .synopsis").html().match(/Episodes: (\d+)/)?.[1] || null;
    const duration = $2("#drama-details .synopsis").html().match(/Duration: ([^<]+)/)?.[1]?.trim() || null;
    const rating = $2("#drama-details .synopsis").html().match(/Content Rating: ([^<]+)/)?.[1]?.trim() || null;
    const airs = $2("#drama-details .synopsis").html().match(/Airs On: ([^<]+)/)?.[1]?.trim() || null;
    const country = $2("#drama-details p.country a").text().trim() || null;
    const status = $2("#drama-details p.status a").text().trim() || null;
    const release_year = $2("#drama-details p.release-year a").text().trim() || null;
    const genres = $2("#drama-details p.genres a").map((_, el) => $2(el).text().trim()).get() || null;
    const starring = $2("#drama-details p.starring a").map((_, el) => $2(el).text().trim()).get() || null;
    const trailerElement = $2("#drama-details .trailer iframe");
    const trailer = trailerElement.length > 0 ? trailerElement.attr("src") : null;
    const episodes = $2("#episode-list .episode-list li").map((_, el) => {
      const episodeTitle = $2(el).find("h3 a").text().trim();
      const episodeLink = $2(el).find("h3 a").attr("href").trim();
      const episodeTime = $2(el).find(".time").text().trim();
      return { title: episodeTitle, link: episodeLink, time: episodeTime };
    }).get();
    return new Response(
      JSON.stringify({
        success: true,
...
var init_info = __esm({
  "api/dramacool/info.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    init_axios2();
    __name2(validateApiKey5, "validateApiKey");
    __name2(onRequest12, "onRequest");
  }
});
function validateApiKey6(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
__name(validateApiKey6, "validateApiKey6");
async function onRequest13({ request, env: env2 }) {
  try {
    const url = new URL(request.url);
    const page = url.searchParams.get("page") || "1";
    const apiKey2 = url.searchParams.get("api_key");
    if (!apiKey2 || !validateApiKey6(apiKey2, env2)) {
      return new Response(
        JSON.stringify({
          success: false,
          message: "Invalid or missing API key. You can\u2019t call this a drama API without the drama of finding your missing key!",
    ...
    const targetUrl = `https://dramacool.sh/category/latest-asian-drama-releases/page/${page}/`;
    const response = await axios_default.get(targetUrl);
    const html3 = response.data;
    const $2 = load(html3);
    const dramas = [];
    $2("#primary.episode-category.wrapper .box li").each((_, element) => {
      const title = $2(element).find("h3").text().trim();
      let link = $2(element).find("a").attr("href");
      const image = $2(element).find("img").attr("data-original") || $2(element).find("img").attr("src");
      const episode = $2(element).find(".ep").text().trim();
...
var init_latest = __esm({
  "api/dramacool/latest.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    init_axios2();
    __name2(validateApiKey6, "validateApiKey");
    __name2(onRequest13, "onRequest");
  }
});
function validateApiKey7(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
__name(validateApiKey7, "validateApiKey7");
async function onRequest14({ request, env: env2 }) {
  try {
    const url = new URL(request.url);
    const page = url.searchParams.get("page") || "1";
    const apiKey2 = url.searchParams.get("api_key");
    if (!apiKey2 || !validateApiKey7(apiKey2, env2)) {
      return new Response(
        JSON.stringify({
          success: false,
          message: "Invalid or missing API key. You can\u2019t call this a drama API without the drama of finding your missing key!",
...
var init_latest_kshow = __esm({
  "api/dramacool/latest_kshow.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    init_axios2();
    __name2(validateApiKey7, "validateApiKey");
    __name2(onRequest14, "onRequest");
  }
});
function validateApiKey8(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
__name(validateApiKey8, "validateApiKey8");
async function onRequest15({ request, env: env2 }) {
  try {
    const url = new URL(request.url);
    const page = url.searchParams.get("page") || "1";
    const apiKey2 = url.searchParams.get("api_key");
    if (!apiKey2 || !validateApiKey8(apiKey2, env2)) {
      return new Response(
        JSON.stringify({
          success: false,
          message: "Invalid or missing API key. You can\u2019t call this a drama API without the drama of finding your missing key!",
    ...
    const targetUrl = `https://dramacool.sh/tag/most-popular-dramas/page/${page}/`;
    const response = await axios_default.get(targetUrl);
    const html3 = response.data;
    const $2 = load(html3);
    const dramas = [];
...
var init_popular = __esm({
  "api/dramacool/popular.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    init_axios2();
    __name2(validateApiKey8, "validateApiKey");
    __name2(onRequest15, "onRequest");
  }
});
function validateApiKey9(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
__name(validateApiKey9, "validateApiKey9");
async function onRequest16({ request, env: env2 }) {
  try {
    const url = new URL(request.url);
    const query = url.searchParams.get("query");
    const page = url.searchParams.get("page") || "1";
    const apiKey2 = url.searchParams.get("api_key");
    if (!apiKey2 || !validateApiKey9(apiKey2, env2)) {
      return new Response(
        JSON.stringify({
          success: false,
          message: "Invalid or missing API key. You can\u2019t call this a drama API without the drama of finding your missing key!",
    ...
    const $2 = load(html3);
    const dramas = [];
    $2("#main.site-main.wrapper .list-thumb li").each((_, element) => {
      const title = $2(element).find("h2 a").text().trim();
      const link = $2(element).find("h2 a").attr("href");
      const image = $2(element).find("img").attr("data-original") || $2(element).find("img").attr("src");
      const synopsis = $2(element).find("p").not(".post-info").text().trim();
      const releaseYear = $2(element).find(".post-info strong:contains('Release Year:')").next("a").text().trim();
      if (title && link) {
        dramas.push({
          title,
          link,
          image: image || null,
          // Default to null if image is not found
          synopsis: synopsis || null,
          // Default to null if synopsis is not found
          releaseYear: releaseYear || null
          // Default to null if release year is not found
        });
      }
    });
    const nextPage = $2(".pagination .next.page-numbers").attr("href") ? true : false;
...
var init_search = __esm({
  "api/dramacool/search.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    init_axios2();
    __name2(validateApiKey9, "validateApiKey");
    __name2(onRequest16, "onRequest");
  }
});
function validateApiKey10(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
__name(validateApiKey10, "validateApiKey10");
async function onRequest17(context) {
  ...
  if (request.method === "GET") {
    ...
    if (!apiKey || !validateApiKey10(apiKey, env)) {
      return new Response(
        JSON.stringify({
          success: false,
          message: "Invalid or missing API key. You can\u2019t call this a drama API without the drama of finding your missing key!",
    ...
    try {
      ...
      if (!episodeResponse.ok) {
        return new Response(JSON.stringify({ success: false, error: `Failed to fetch episode URL: ${episodeResponse.statusText}` }), {
          status: 500,
          headers: { "Content-Type": "application/json" }
        });
      }
      ...
      while ((serverMatch = serverRegex.exec(episodeHtml)) !== null) {
        ...
        servers[serverName] = { embeded_link: serverLink };
      }
      if (Object.keys(servers).length === 0) {
        return new Response(JSON.stringify({ success: false, error: "No servers found in episode HTML." }), {
          status: 400,
          headers: { "Content-Type": "application/json" }
        });
      }
      for (const [serverName, serverData] of Object.entries(servers)) {
        if (["doodstream", "mixdrop", "standard"].includes(serverName)) {
          servers[serverName].skipped = true;
          continue;
        }
        try {
          const serverResponse = await fetch(serverData.embeded_link);
          if (!serverResponse.ok) {
            servers[serverName].error = `Failed to fetch server content: ${serverResponse.statusText}`;
            continue;
          }
          ...
          let scriptContent;
          let match2;
          while ((match2 = scriptRegex.exec(serverHtml)) !== null) {
            if (match2[1].includes("eval(function(p,a,c,k,e,d)")) {
              scriptContent = match2[1];
              break;
            }
          ...
          if (!scriptContent) {
            servers[serverName].error = "Obfuscated script not found in server HTML.";
            continue;
          }
          const evalRegex = /eval\(function\(p,a,c,k,e,d\)\{.*?\}\('(.+?)',(\d+),(\d+),'(.+?)'\.split\('\|'\)\)\)/;
          const obfuscatedMatch = scriptContent.match(evalRegex);
          if (!obfuscatedMatch) {
            servers[serverName].error = "Failed to parse obfuscated code.";
            continue;
          }
          const [_, obfuscatedCode, deobfuscationKey, arrayLength, deobfuscationArray] = obfuscatedMatch;
          const deobfuscatedOutput = deobfuscateCode2(
          ...
          const urls = extractUrls2(deobfuscatedOutput);
          Object.assign(servers[serverName], findSpecificUrls2(urls));
        } catch (error) {
          servers[serverName].error = `Error processing server: ${error.message}`;
        }
      }
      ...
      return new Response(JSON.stringify({ success: false, error: `Error processing episode ID: ${error.message}` }), {
        status: 500,
        headers: { "Content-Type": "application/json" }
      });
    }
  }
  return new Response(JSON.stringify({ success: false, error: "Unsupported request method" }), {
    status: 405,
    headers: { "Content-Type": "application/json" }
  });
}
...
var init_stream2 = __esm({
  "api/dramacool/stream.js"() {
    init_functionsRoutes_0_5035528585987676();
    __name2(validateApiKey10, "validateApiKey");
    __name2(onRequest17, "onRequest");
  }
});
function validateApiKey11(apiKey2, env2) {
  const validApiKeys = (env2.API_KEYS || "").split(",");
  return validApiKeys.includes(apiKey2);
}
__name(validateApiKey11, "validateApiKey11");
async function onRequest18({ request, env: env2 }) {
  try {
    const url = new URL(request.url);
    const page = url.searchParams.get("page") || "1";
    const apiKey2 = url.searchParams.get("api_key");
    if (!apiKey2 || !validateApiKey11(apiKey2, env2)) {
      return new Response(
        JSON.stringify({
          success: false,
          message: "Invalid or missing API key. You can\u2019t call this a drama API without the drama of finding your missing key!",
    ...
    const targetUrl = `https://dramacool.sh/upcoming-asian-dramas/page/${page}/`;
    const response = await axios_default.get(targetUrl);
    const html3 = response.data;
    const $2 = load(html3);
    const dramas = [];
...
var init_upcoming = __esm({
  "api/dramacool/upcoming.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    init_axios2();
    __name2(validateApiKey11, "validateApiKey");
...
async function onRequest19(context) {
  ...
  try {
    const response = await axios_default.get(myurl);
    const html3 = response.data;
    const $2 = load(html3);
    const title = $2("h1.entry-title a").text().trim();
    const imdbRating = $2('li:contains("IMDb Rating") a').text().trim();
    const genres = $2('li:contains("Genres") a').map((_, el) => $2(el).text().trim()).get();
    const language = $2('li:contains("Language")').text().split(":")[1]?.trim();
    const quality = $2('li:contains("Quality")').text().split(":")[1]?.trim();
    const storyline = $2("h2:contains('Storyline') + p").text().trim();
    const downloadLinks = [];
    $2("a").each((_, link) => {
      const href = $2(link).attr("href");
      const text3 = $2(link).text().trim();
      if (href && (text3.match(/\d+p/) || text3.toLowerCase().includes("download"))) {
        const qualityMatch = text3.match(/\d+p/);
...
var init_getDetail = __esm({
  "api/katmovies/getDetail.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    init_axios2();
...
async function onRequest20(context) {
  try {
    const response = await axios_default.get("https://katmoviehd.nexus/");
    const html3 = response.data;
    const $2 = load(html3);
    const movies = [];
    $2("ul.recent-posts > li").each((index2, element) => {
      const title = $2(element).find("h2 > a").attr("title");
      const link = $2(element).find("h2 > a").attr("href");
      const image = $2(element).find(".post-thumb > a > img").attr("src");
      const categories = $2(element).find(".meta-category > a").map((i, cat) => $2(cat).text()).get();
      movies.push({
        title,
        link,
        image,
...
var init_getHome = __esm({
  "api/katmovies/getHome.js"() {
    init_functionsRoutes_0_5035528585987676();
    init_browser();
    init_axios2();
...
async function onRequest21() {
  try {
    const response = await axios_default.get("https://kisskh.asia/");
    const html3 = response.data;
    const $2 = load(html3);
    ...
    $2(".bixbox .listupd .excstf article").each((_, element) => {
      const title = $2(element).find(".tt h2").text().trim();
      const link = $2(element).find(".bsx > a").attr("href");
      const image = $2(element).find(".bsx img").attr("src");
      const episode = $2(element).find(".bt .epx").text().trim();
      const subtitle = $2(element).find(".bt .sb").text().trim();
      const status = $2(element).find(".limit .status").text().trim() || "Ongoing";
      latestReleases.push({
        title,
        link,
        image,
    ...
    $2(".series-gen .nav-tabs li").each((_, tab) => {
      const genreName = $2(tab).find("a").text().trim();
      const genreId = $2(tab).find("a").attr("href").replace("#", "");
      const genreRecommendations = [];
      $2(`#${genreId} article`).each((_2, element) => {
        const title = $2(element).find(".tt h2").text().trim();
        const link = $2(element).find(".bsx > a").attr("href");
        const image = $2(element).find(".bsx img").attr("src");
        const status = $2(element).find(".bt .epx").text().trim() || "Ongoing";
        const subtitle = $2(element).find(".bt .sb").text().trim();
    ...
    $2(".serieslist.pop.wpop").each((_, section) => {
      const range = $2(section).attr("class").split(" ").find((cls) => cls.startsWith("wpop-")).replace("wpop-", "");
      $2(section).find("li").each((_2, element) => {
        const rank = $2(element).find(".ctr").text().trim();
        const title = $2(element).find(".leftseries h4 a").text().trim();
        const link = $2(element).find(".imgseries a").attr("href");
        const image = $2(element).find(".imgseries img").attr("src");
        const genres = [];
        $2(element).find(".leftseries span a").each((_3, genre) => {
          genres.push($2(genre).text().trim());
        });
        const rating = $2(element).find(".numscore").text().trim() || null;
...
var routes;
var init_functionsRoutes_0_5035528585987676 = __esm({
  "../.wrangler/tmp/pages-mdoskE/functionsRoutes-0.5035528585987676.mjs"() {
    init_getStream();
    init_doc();
    init_getm3u8();
    init_getVideo();
...
// .wrangler/tmp/bundle-Kqb40k/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Kqb40k/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5539741807846019.js.map
